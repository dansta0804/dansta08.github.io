...
\begin{table}[htb!]
    ...
    \begin{tabular}{|m{3cm}|m{13.7cm}|}
        ...
        Realizavus šį panaudojimo atvejį skirtingos naudotojų grupės sistemoje
        gali atlikti skirtingus veiksmus: pacientai gali įkelti savo biologinius
        duomenis, kurie gali būti panaudoti moksliniais tikslais, papildant
        biologinių duomenų saugyklą naujais genetiniais variantais; gydytojai -
        genetikai gali įkelti genetinius pacientų duomenis, kad jie būtų
        detaliau išanalizuoti tyrėjų ir būtų galima paskirti tolimesnes
        sutrikimo ar ligos gydymo priemones. \\
        \hline
        \raggedleft \textbf{\cellcolor{deepchampagne}Prioritetas} & Aukštas. \\
        \hline
        \raggedleft \textbf{\cellcolor{deepchampagne}Užsakovo tenkinimas} &
        ...
        \makecell[l]{\parbox[t]{13.7cm}{
            ...
            mygtuką.} \\
            \textbf{3.} \textcolor{deepcarmine}{Sistema validuoja failo formatą
            ir turinį.} \\
            \textbf{4.} \textcolor{deepcarmine}{Sistema užšifruota duomenis ir
            išsaugo juos duomenų bazėje.} \\
            \textbf{5.} \textcolor{deepcarmine}{Sistema įrašo metainformaciją
            apie įkeltą failą į blokų grandinę (taip užtikrinant duomenų
            nekintamumą ir veiksmų atsekamumą).} \\
            \textbf{6.} \textcolor{deepcarmine}{Sistema priskiria įrašui
            identifikatorių ir susieja jį su naudotojo paskyra.} \\
            \textbf{7.} \textcolor{deepcarmine}{Parodomas informacinis
            pranešimas, informuojantis apie sėkmingai įkeltus duomenis.} \\
            \textbf{8.} \textcolor{deepcarmine}{Naudotojas peržiūri įkeltų
            duomenų įrašą savo paskyros skiltyje.} \\

            \textbf{4.} \textcolor{deepcarmine}{ Parodomas informacinis
            pranešimas, informuojantis apie sėkmingai sukurtą asmeninę
            paskyrą.}
            \\
            \textbf{4.} \textcolor{deepcarmine}{Sistema prijungia naudotoją
