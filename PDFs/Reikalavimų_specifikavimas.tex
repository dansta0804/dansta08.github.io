...
Skaitmeniniame amžiuje, kai asmens tapatybės duomenys tampa itin svarbiu
aspektu, privatumo užtikrinimas ir efektyvus tapatybės valdymas yra pagrindiniai
iššūkiai, su kuriais turi susidurti ne tik privatūs asmenys, bet ir įvairios
organizacijos. Šiais laikais daug dėmesio skiriama asmens identifikaciniams
duomenims. Pavyzdžiui, vardui, pavardei, asmens kodui, adresui ir pan. Nepaisant
to, be šių duomenų egzistuoja ir kiti jautrūs asmens duomenys, kurie reikalauja
atitinkamo valdymo ir apsaugos. Vienas iš tokių duomenų pavyzdžių yra genetiniai
duomenys, kurie atskleidžia ne tik asmens sveikatos informaciją, bet ir
paveldimumo ypatybes, ligų rizikas bei kitus svarbius su asmens sveikatos būkle
susijusius aspektus. Dėl to šiais laikais būtina kurti ne tik sistemas, kuriose
didelis dėmesys būtų skiriamas ne tik standartiniams asmenį identifikuojantiems
duomenims, bet ir genetinei asmens informacijai.

Šiuo metu genetinių duomenų keitimosi procesas tarp pacientų, gydytojų ir
mokslinių tyrimų institucijų yra sudėtingas ir dažnai nesaugus. Duomenys yra
saugomi skirtingose nesusijusiose informacinėse sistemose, o duomenų prieigos
kontrolės mechanizmai dažnai yra riboti arba nepakankamai patikimi. Dėl to šiuo
projektu yra siekiama sukurti vieningą sistemą, kuri būtų skirta pacientams,
gydytojams ir mokslinių tyrimų institucijų tyrėjams ir kuri leistų saugiai,
pritaikius pseudonimizavimo metodikas, keistis genetiniais duomenimis bei
vykdyti šių duomenų analizę.
...
Žemiau yra pateikiami potencialių sistemos naudotojų - pacientų, gydytojų
(genetikų) ir tyrėjų - aprašymai kartu su šių naudotojų charakteristikomis.
...
\begin{table}[htb!]
    ...
    \begin{tabular}{|m{4cm}|m{12cm}|}
        ...
        asmeninius genetinius duomenis, kurie gali būti panaudoti ne tik
...
\begin{table}[htb!]
    ...
    \begin{tabular}{|m{4cm}|m{12cm}|}
        \hline
        \raggedleft \textbf{\cellcolor{deepchampagne}Funkcijos} &
        Įkelti pacientų genetinius duomenis; inicijuoti genetinių duomenų
        analizių atlikimą ir jų rezultatus pateikti pacientams; gavus leidimą
        iš paciento perduoti genetinius duomenis tyrėjams. \\
        \hline
        \raggedleft \textbf{\cellcolor{deepchampagne}Patirtis dalykinėje
        srityje} & Aukšta. \\
        \hline
        ...
        darbo pobūdis (darbas su pacientų genetiniais duomenimis) ir dalykinė
...
sistemos MySQL pagrindu.

\newpage

\subsection{Numatoma darbo vietos aplinka}
Numatomiems sistemoms naudotojams - pacientams, gydytojams ir tyrėjams -
būdingos žemiau aprašytos darbo vietos charakteristikos
(\hyperref[table:DARBO_VIETA]{2 lentelė}).
    ...
    \begin{tabular}{
        ...
        \multicolumn{1}{|>{\raggedright\arraybackslash}m{12cm}|}{
            \begin{itemize}[leftmargin=0.5cm]
                ...
                kabinetuose, leidžiančiuose užtikrinti pacientų konfidencialumą
                konsultacijų metu.
...
\begin{table}[htb!]
    ...
    \begin{tabular}{
        ...
        \textcolor{red}{1 125} \\
        \hline
        \raggedright\textbf{\cellcolor{wheat}{3. Programinė įranga}} &
        \cellcolor{wheat} & \cellcolor{wheat} & \cellcolor{wheat} &
        \cellcolor{wheat} \\
        \hline
        ...
        \textcolor{red}{406,6} \\
        \hline
        \raggedright\textbf{\cellcolor{wheat}{4. Viso tiesioginiai
        projekto kaštai}} &
        \cellcolor{wheat} & \cellcolor{wheat} & \cellcolor{wheat} &
        \cellcolor{wheat}\textcolor{red}{\textbf{116 731,6}} \\
        \hline
    \end{tabular}
\end{table}
...
\begin{figure}[ht]
    \begin{center}
        \captionsetup{justification=centering}
        \includegraphics[width=1.0\linewidth]{Konteksto_diagrama_V2.png}
...
Žemiau esančiame paveiksle pavaizduota sistemos panaudojimo atvejų modelio
diagrama:
...
Šiame skyriuje yra aprašyti kuriamos pseudonimizuotos genetinių duomenų
keitimosi sistemos panaudojimo atvejai.
...
\begin{table}[htb!]
    ...
    \begin{tabular}{|m{2.9cm}|m{14.3cm}|}
        ...
        genetikai gali kurti pacientų analizių korteles, įkelti pacientų
...
\begin{table}[htb!]
    ...
    \begin{tabular}{|m{3cm}|m{13.7cm}|}
        ...
        \makecell[l]{\parbox[t]{13.7cm}{
            ...
            \textbf{5.} {Biologinių duomenų įrašui priskiriamas unikalus
            ...
            \textbf{7.} \textcolor{dartmouthgreen}{Atveriama naudotojo paskyros
...
\begin{table}[htb!]
    ...
    \begin{tabular}{|m{3cm}|m{13.7cm}|}
        ...
        \makecell[l]{\parbox[t]{13.7cm}{
            ...
            \textbf{5.} {Parodomas informacinis pranešimas, informuojantis apie
            nesėkmingą prieigos teisių atnaujinimą (tuo atveju, jei naudotojas
            neaktyvus - nebedirba įstaigoje, dirbančioje su kuriama sistema).} \\
...
\begin{table}[htb!]
    ...
    \begin{tabular}{|m{3cm}|m{13.7cm}|}
        ...
        \makecell[l]{\parbox[t]{13.7cm}{
            ...
            „pamiršimo“ įvykį duomenų bazėje.} \\
            \textbf{6.} {Parodomas informacinis pranešimas, informuojantis apie
        ...
        \makecell[l]{\parbox[t]{13.7cm}{
            ...
            biologiniais duomenimis tebėra atliekamos analizės.} \\
            \textbf{6.} {Parodomas informacinis
...
\begin{table}[htb!]
    ...
    \begin{tabular}{|m{3cm}|m{13.7cm}|}
        ...
        \makecell[l]{\parbox[t]{13.7cm}{
            ...
            analizės metodą, naudodamasis integruota arba išorine analizės
            vykdymo programine įranga.} \\
            \textbf{3.} {Atliekant analizę paaiškėja, kad pateikti biologiniai
            duomenys yra nepakankami arba netinkami, todėl gydytojo - genetiko
            siųsta analizės atlikimo užklausa yra atmetama, pateikiant detalias
            atmetimo priežastis.} \\
            \textbf{4. Baigiamas PA.}
        }}
        \\
...
\begin{table}[htb!]
    ...
    \begin{tabular}{|m{4.8cm}|m{12cm}|}
        ...
        iš 3 galimų: „pacientas“, „gydytojas - genetikas“, „tyrėjas“. \\
        \hline
...
\begin{table}[htb!]
    ...
    \begin{tabular}{|m{4.8cm}|m{12cm}|}
        ...
        analizę arba pateikus užklausą dėl analizės atlikimo bei paspaudus
...
\begin{table}[htb!]
    ...
    \begin{tabular}{|m{4.8cm}|m{12cm}|}
        ...
        \hline
        \raggedleft \textbf{\cellcolor{deepchampagne}Tikimo kriterijus} &
        Visi duomenys duomenų bazėje ir failų sistemoje yra
...
\begin{table}[htb!]
    ...
    \begin{tabular}{|m{4.8cm}|m{12cm}|}
        ...
        \hline
        \raggedleft \textbf{\cellcolor{deepchampagne}Priklausomybės} &
        \hyperlink{FR15}{\textcolor{steelblue}{\textbf{FR15:}
...
\begin{table}[htb!]
    ...
    \begin{tabular}{|m{4.8cm}|m{12cm}|}
        ...
        \hline
        \raggedleft \textbf{\cellcolor{deepchampagne}Priklausomybės} &
        \hyperlink{FR17}{\textcolor{steelblue}{\textbf{FR17:}
...
\begin{table}[htb!]
    ...
    \begin{tabular}{|m{4.8cm}|m{12cm}|}
        ...
        \hline
        \raggedleft \textbf{\cellcolor{deepchampagne}Pagrindimas} &
        Kuriamoje sistemoje duomenų savininkas pats valdo savo duomenis ir pats
        suteikia prieigą prie šių duomenų kitiems naudotojams, todėl prieš
        atliekant biologinių duomenų analizę svarbu įsitikinti, ar duomenų
        savininkas yra davęs leidimą dirbti su jo duomenimis. \\
        \hline
        \raggedleft \textbf{\cellcolor{deepchampagne}Šaltinis} & Užsakovas. \\
        \hline
        \raggedleft \textbf{\cellcolor{deepchampagne}Tikimo kriterijus} & 
...
\begin{table}[htb!]
    ...
    \begin{tabular}{|m{4.8cm}|m{12cm}|}
        ...
        analizių sąrašas pateiktas
        \hyperref[sec:ANALYSES]{\textbf{\color{steelblue}{Priede Nr.1}}}. \\
        \hline
        \raggedleft \textbf{\cellcolor{deepchampagne}Pagrindimas} & Analizių
        atlikimas su biologiniais duomenimis yra esminis sistemos
        funkcionalumas. \\
...
\begin{figure}[ht]
    \begin{center}
        \captionsetup{justification=centering}
        \includegraphics[width=1.05\linewidth]{ER_V2.png}
        \vspace{-1\baselineskip}
...
kuris yra sugeneruojamas paciento, no\-rin\-čio, kad jo duomenys būtų panaikinti
iš sistemos.
\label{sec:E5}
\begin{table}[htb!]
    \captionsetup{justification=centering}
...
Kuriant pseudonimizuotą genetinių duomenų keitimosi sistemą turi būti laikomasi
žemiau aprašytų sistemos išvaizdos reikalavimų.
\vskip 10pt
...
Kuriant pseudonimizuotą genetinių duomenų keitimosi sistemą turi būti laikomasi
žemiau aprašytų panaudojamumo reikalavimų.
\vskip 10pt
...
Kuriant pseudonimizuotą genetinių duomenų keitimosi sistemą turi būti laikomasi
žemiau aprašytų vykdymo charakteristikų reikalavimų.
\vskip 10pt
...
\begin{table}[htb!]
    ...
    \begin{tabular}{|m{4.9cm}|m{11cm}|}
        ...
        suteikimo neviršija 500 ms, laikoma, kad nefunkcinis reikalavimas
        įgyvendintas. \\
        \hline
...
Kuriant pseudonimizuotą genetinių duomenų keitimosi sistemą turi būti laikomasi
žemiau aprašytų saugumo reikalavimų.
\vskip 10pt
...
biologinių duomenų, naudojant pseudonimizaciją.
\label{sec:NFR9}
\begin{table}[htb!]
    \captionsetup{justification=centering}
    \vskip -10pt
    \begin{tabular}{|m{4.9cm}|m{11cm}|}
        ...
        tikslą pasiekti padeda pseudonimizavimo procesas. \\
        \hline
        \raggedleft \textbf{\cellcolor{deepchampagne}Šaltinis} & Užsakovas. \\
        \hline
        \raggedleft \textbf{\cellcolor{deepchampagne}Atitikimo kriterijus} & 
...
Kuriant pseudonimizuotą genetinių duomenų keitimosi sistemą turi būti laikomasi
žemiau aprašyto teisinio reikalavimo.
\vskip 10pt

\noindent \textbf{NFR10:} Sistemoje turi būti laikomasi BDAR reikalavimo dėl
...
Pseudonimizuota genetinių duomenų keitimosi sistema kuriama etapais, kur žemiau
pateiktoje lentelėje (\hyperref[sec:PATEIKIMO_ETAPAI]{12 lentelė}) aprašyti
tarpiniai sistemos kūrimo eigoje pasiekti rezultatai.

\label{sec:PATEIKIMO_ETAPAI}
\begin{table}[htb!]
    \captionsetup{justification=centering}
    \caption{\small\textbf{Sistemos pateikimo etapai}.}
    \vskip -10pt
    \begin{tabular}{
        ...
        \textbf{\cellcolor{deepchampagne}Etapo pavadinimas} &
        \textbf{\cellcolor{deepchampagne}Laikotarpis}  \\
        \hline
        \multicolumn{1}{|>{\arraybackslash}m{0.7cm}|}{1.} &
        \multicolumn{1}{>{\raggedright\arraybackslash}m{6cm}|}{Literatūros
        analizės vykdymas} &
        \multicolumn{1}{>{\raggedright\arraybackslash}m{7cm}|}{Nuo 2024-10-01
        iki 2024-11-13}\\
        \hline
        \multicolumn{1}{|>{\arraybackslash}m{0.7cm}|}{2.} &
        \multicolumn{1}{>{\raggedright\arraybackslash}m{6cm}|}{Projekto
        paruošimas \emph{(projekto paraiškos ir plano parengimas)}} &
        \multicolumn{1}{>{\raggedright\arraybackslash}m{7cm}|}{Nuo 2024-11-13
        iki 2024-12-20}\\
        \hline
        \multicolumn{1}{|>{\arraybackslash}m{0.7cm}|}{3.} &
        \multicolumn{1}{>{\raggedright\arraybackslash}m{6cm}|}{Reikalavimų
        surinkimas ir specifikavimas} &
        \multicolumn{1}{>{\raggedright\arraybackslash}m{7cm}|}{Nuo 2025-02-03
        iki 2025-09-30.}\\
        \hline
        \multicolumn{1}{|>{\arraybackslash}m{0.7cm}|}{4.} &
        \multicolumn{1}{>{\raggedright\arraybackslash}m{6cm}|}{Sistemos
        architektūros projektavimas} &
        \multicolumn{1}{>{\raggedright\arraybackslash}m{7cm}|}{Nuo 2025-03-13
        iki 2025-09-30.}\\
        \hline
        \multicolumn{1}{|>{\arraybackslash}m{0.7cm}|}{5.} &
        \multicolumn{1}{>{\raggedright\arraybackslash}m{6cm}|}{Sistemos
        realizavimas} &
        \multicolumn{1}{>{\raggedright\arraybackslash}m{7cm}|}{Nuo 2025-10-06
        iki 2025-11-10}\\
        \hline
        \multicolumn{1}{|>{\arraybackslash}m{0.7cm}|}{6.} &
        \multicolumn{1}{>{\raggedright\arraybackslash}m{6cm}|}{Sistemos
        testavimas} &
        \multicolumn{1}{>{\raggedright\arraybackslash}m{7cm}|}{Nuo 2025-11-10
        iki 2025-11-20}\\
        \hline
        \multicolumn{1}{|>{\arraybackslash}m{0.7cm}|}{7.} &
        \multicolumn{1}{>{\raggedright\arraybackslash}m{6cm}|}{Sistemos
        diegimas} &
        \multicolumn{1}{>{\raggedright\arraybackslash}m{7cm}|}{Paaiškės
...
Sistemos vystymas suskaidytas į atskirus etapus:

\subsubsection*{\noindent \textbf{1.} Grafinės naudotojo sąsajos sukūrimas
\emph{(registracijos modulis)}}

\noindent Etapas turi būti įgyvendintas iki 2025-10-01. Susiję reikalavimai:
...
\noindent Etapas turi būti įgyvendintas iki 2025-10-25. Susiję reikalavimai:
...
\begin{itemize}[leftmargin=0.3cm, itemsep=-7pt, topsep=1pt, after=\vspace{-1em}]
    ...
    duomenų naikinimas}}
    \item \hyperlink{FR17}{\textcolor{steelblue}{\textbf{FR17:} Prieigos prie
    duomenų tikrinimas}}
\end{itemize}
...
\subsubsection*{\noindent \textbf{4.} Grafinės naudotojo sąsajos sukūrimas
\emph{(tyrėjų modulis)}}

\noindent Etapas turi būti įgyvendintas iki 2025-10-25. Susiję reikalavimai:
\begin{itemize}[leftmargin=0.3cm, itemsep=-7pt, topsep=1pt, after=\vspace{-1em}]
    \item \hyperlink{FR16}{\textcolor{steelblue}{\textbf{FR16:} Analizės
    atlikimo užklausos gavimas}}
    \item \hyperlink{FR18}{\textcolor{steelblue}{\textbf{FR18:} Biologinių
    duomenų analizės atlikimas}}
\end{itemize}


\subsubsection*{\noindent \textbf{5.} Sistemoje įvedamų duomenų saugojimas
duomenų bazėje ir šifravimo realizavimas}

\noindent Etapas turi būti įgyvendintas iki 2025-11-15. Susiję reikalavimai:
...
\subsubsection*{\noindent \textbf{6.} Biologinių analizių funkcionalumo
realizavimas}
...
\noindent \textbf{R1:} Nepaisant pseudonimizavimo, biologiniai duomenys gali
...
\noindent \textbf{R2:} Sistemoje realizuotas funkcionalumas gali neatitikti
...
\noindent \textbf{R3:} Dėl sistemos gedimo ar neteisingo atsarginio kopijavimo
...
\noindent \textbf{R4:} Sistemos veikimo sutrikimai, galintys kilti po
...
\noindent \textbf{R5:} Dėl nenumatytų priežasčių gali vėluoti projektas -
...
\textcolor{steelblue}{\emph{\ref{sec:BIUDZETAS} \nameref{sec:BIUDZETAS}}} skyrių
...
\begin{table}[htb!]
    ...
    \begin{tabular}{|>{\raggedright\arraybackslash}m{16cm}|}
        ...
        molekulinėmis funkcijomis bei ląsteliniais komponentais susijusios
        praturtintos sekos. \\
        \hline
